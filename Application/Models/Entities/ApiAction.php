...
/**
 * @Entity
 * @Table(name="api_actions",indexes={@index(name="api_action_event_idx", columns={"event"})})
 */
class ApiAction implements \ArrayAccess
{
    /**
     * @Id
     * @Column(type="integer")
    ...
    /**
     * Many requests per 1 API
     *
     * @ManyToOne(targetEntity="Api", inversedBy="actions")
     */
    private $api;
