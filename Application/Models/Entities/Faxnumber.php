 ...
 * @Table(name="faxes")
 */
class Faxnumber implements \ArrayAccess {
    /**
     * @Id
     * @Column(type="integer")
     * @GeneratedValue
    ...
    /**
     * @ManyToOne(targetEntity="Person", inversedBy="faxnumbers")
     */
    private $person;
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('number', new Assert\MinLength(array(
            'limit' => 7,
            'message' => 'A faxnumber must have at least {{ limit }} characters, not including dashes or parenthesis',
            'groups' => array('default'),
        )));
        $metadata->addPropertyConstraint('number', new Assert\MaxLength(array(
            'limit' => 20,
            'message' => 'A faxnumber cannot be longer than {{ limit }} characters, including dashes or parenthesis',
            'groups' => array('default'),
        )));
    }
