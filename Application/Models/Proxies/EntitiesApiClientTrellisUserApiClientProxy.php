 ...
 */
class EntitiesApiClientTrellisUserApiClientProxy extends \Entities\ApiClient\TrellisUserApiClient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'ip_address', 'url', 'api_key', 'api_secret', 'status', 'approval', 'notes', 'created', 'updated', 'account', 'api', 'how_will_use');
    }
