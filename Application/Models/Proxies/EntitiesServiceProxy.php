 ...
 */
class EntitiesServiceProxy extends \Entities\Service implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getServiceStateFromWebservice();
    }
    ...
    {
        $this->__load();
        return parent::getIsRunning();
    }

    public function setIsRunning($is_running)
    {
        $this->__load();
        return parent::setIsRunning($is_running);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'icon', 'description', 'type', 'notes', 'isRunning', 'maintenanceMessage', 'users', 'requests', 'maintainer', 'actions');
    }
