 ...
 */
class EntitiesServiceRequestAtmosphereRequestProxy extends \Entities\ServiceRequest\AtmosphereRequest implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ip_address', 'approval', 'notes', 'created', 'updated', 'status', 'account', 'service', 'how_will_use');
    }
